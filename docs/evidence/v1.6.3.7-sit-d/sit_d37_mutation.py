...
MUTATIONS = [
    ...
    {"id": "MC", "target": "created_at 时区口径用例", "file": W,
     "find": '            results_json, created_by, "", None, "", now_local,',
     "repl": '            results_json, created_by, "", None, "", _utcnow(),',
     "test": "tests/test_v1636_bugs.py::test_metadata_audit_history_created_at_is_local_time",
     "desc": "created_at 回退为 UTC（文件名与提取时间错位 8 小时）"},
