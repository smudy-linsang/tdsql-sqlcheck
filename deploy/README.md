...
| `verify_deploy.sh` | 部署后一键冒烟（health/版本/登录/121规则/审核命中/元数据库/metrics） | 目标服务器 |
...
tar -xzf tdsql-sqlcheck-v1.0.3-linux-x86_64.tar.gz && cd tdsql-sqlcheck-v1.0.3-linux-x86_64
