...
const app=createApp({
  setup(){
    ...
    const loadAll=async()=>{
      ...
      const menuOrder=['dashboard','sql-audit','file-audit','schema-extractor-audit','instances','slow-overview','slow-records','slow-tasks','bigtable','deep-diag','projects','rulesets','gate','monitor','inspection','sys-users','sys-roles','sys-perms','sys-auditlog','sys-retention','sys-info'];
