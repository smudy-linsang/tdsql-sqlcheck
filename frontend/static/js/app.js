...
const app=createApp({
  setup(){
    ...
    const goExplainFromSlow=(d)=>{currentPage.value='explain';explainMode.value='sql';explainSqlInput.value=d.fingerprint||'';if(d.connection_id)explainConnId.value=d.connection_id;slowDetailDrawer.value=false};
