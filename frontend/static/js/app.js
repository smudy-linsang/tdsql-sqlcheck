...
const app=createApp({
  setup(){
    ...
    const loadAll=()=>{loadDashboard();loadSavedConnections();loadRules();loadScanTasks();loadSlowList();loadProjects();loadActiveAlerts();loadLogo()};
